...
public class TemperatureDebugger {
	...
	public static enum Modifier {
		EQUILIBRIUM_TARGET("Equilibrium", ModifierType.TARGET), BIOME_TEMPERATURE_TARGET("Biome Temperature", ModifierType.TARGET),
		NEARBY_BLOCKS_TARGET("Nearby Blocks", ModifierType.TARGET), ALTITUDE_TARGET("Altitude", ModifierType.TARGET),
		ARMOR_TARGET("Armor", ModifierType.TARGET), SPRINTING_TARGET("Sprinting", ModifierType.TARGET), TIME_TARGET("Time", ModifierType.TARGET),
		WET_TARGET("Wet", ModifierType.TARGET), SNOW_TARGET("Snow", ModifierType.TARGET),
		CLIMATISATION_TARGET("Climatisation", ModifierType.TARGET), SEASON_TARGET("Season", ModifierType.TARGET);
