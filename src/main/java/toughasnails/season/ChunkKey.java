...
public class ChunkKey {
	...
	public static final Neighbor[] NEIGHBORS = new Neighbor[] { new Neighbor(1, 0, 2), new Neighbor(1, 1, 7), new Neighbor(-1, 0, 0),
			new Neighbor(-1, 1, 6), new Neighbor(0, 1, 5), new Neighbor(0, -1, 4), new Neighbor(1, -1, 3), new Neighbor(-1, -1, 1) };
	...
	public boolean isAssociatedToWorld(World world) {
		...
		if (world.provider.getDimension() != dimension) return false;
		return true;
	}
