...
public class PotionHypothermia extends TANPotion {
	...
	public void performEffect(EntityLivingBase entity, int amplifier) {
		...
		if (!(entity instanceof EntityPlayer) || (enumdifficulty == EnumDifficulty.EASY && entity.getHealth() > 10.0F)
				|| (enumdifficulty == EnumDifficulty.NORMAL && entity.getHealth() > 1.0F) || enumdifficulty == EnumDifficulty.HARD) {
