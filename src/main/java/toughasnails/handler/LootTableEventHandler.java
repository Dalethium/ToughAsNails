...
public class LootTableEventHandler {
	...
	public void onLootTableLoad(LootTableLoadEvent event) {
		if (event.getName().equals(LootTableList.CHESTS_NETHER_BRIDGE)) {
			...
			if (main != null) {
				main.addEntry(new LootEntryItem(TANItems.lifeblood_crystal, 1, 0, new LootFunction[0], new LootCondition[0],
		...
		if (event.getName().equals(LootTableList.CHESTS_IGLOO_CHEST)) {
			...
			if (main != null) {
				...
				main.addEntry(new LootEntryItem(TANItems.freeze_powder, 4, 3, new LootFunction[0], new LootCondition[0],
						"toughasnails:freeze_powder"));
				main.addEntry(
						new LootEntryItem(TANItems.freeze_rod, 2, 1, new LootFunction[0], new LootCondition[0], "toughasnails:freeze_rod"));
			}
		}
	}
}