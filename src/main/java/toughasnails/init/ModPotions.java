...
public class ModPotions {
	...
	public static void init() {
		...
		cold_resistance =
				registerPotion("cold_resistance", new PotionColdResistance(27).setPotionName("potion.cold_resistance").setBeneficial());
		heat_resistance =
				registerPotion("heat_resistance", new PotionHeatResistance(28).setPotionName("potion.heat_resistance").setBeneficial());

		cold_resistance_type = registerPotionType("cold_resistance_type",
				new PotionType(new PotionEffect[] { new PotionEffect(TANPotions.cold_resistance, 1200) }));
		long_cold_resistance_type = registerPotionType("long_cold_resistance_type",
				new PotionType(new PotionEffect[] { new PotionEffect(TANPotions.cold_resistance, 2400) }));
		heat_resistance_type = registerPotionType("heat_resistance_type",
				new PotionType(new PotionEffect[] { new PotionEffect(TANPotions.heat_resistance, 1200) }));
		long_heat_resistance_type = registerPotionType("long_heat_resistance_type",
				new PotionType(new PotionEffect[] { new PotionEffect(TANPotions.heat_resistance, 2400) }));
	}
